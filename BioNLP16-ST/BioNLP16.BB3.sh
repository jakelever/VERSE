...
# Build the model
$python $verseDir/core/BuildRelationModel.py --trainingFile BioNLP-ST-2016_BB-event_train_AND_dev.verse --relationDescriptions $descFile --parameters "$parameters" --modelFile relations.model

# Run the model
$python $verseDir/core/UseRelationModel.py --modelFile relations.model --testingFile BioNLP-ST-2016_BB-event_test.verse --outFile out.verse
